...
class Forecast {
    ...
    public static List<ForecastResult> getForecast(String cityName) throws IOException, InterruptedException {
        ...
        ProcessBuilder processBuilder = new ProcessBuilder("python", "C:\\Users\\zscbl\\Desktop\\forecast.py", "google", cityName);
...
//        process.waitFor();
        ...
        // 读取CSV文件
        String csvFilePath = "C:\\Users\\zscbl\\Desktop\\temp/forecast_results_" + cityName + ".csv";
