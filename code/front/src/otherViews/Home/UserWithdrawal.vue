        ...
        <div class="header">
          ...
          <div class="form" v-if="preWithdraw">
            <div class="is-accept" v-if="preWithdraw.withdraw_accept || true">
              ...
              <transition name="fade">
                <div class="tip-tag" v-if="isShowTip">
                  ...
                  More than 0 stars can apply for cash withdrawal can be
                  submitted at any time to withdraw the application, but need to
                  complete a transaction before they can submit the next pen,
                  each mention is to 
                </div>
              </transition>
            </div>
            <div class="no-accept" v-if="!preWithdraw.withdraw_accept || false">
              ...
              <div class="noaccept-text">
                <span class="text text1">Submit</span
                ><span class="text text2">Processing</span
                ><span class="text text3">Success</span>
              </div>
            </div>
          </div>
        </div>
...
.tip-tag {
  ...
  line-height: 1.6;
  width: 380px;
  -webkit-box-shadow: 0px 3px 16px #cbc8c8;
  box-shadow: 0px 3px 16px #cbc8c8;
  padding: 20px;
...
.arrow em {
  border-color: transparent transparent #aba9a9;
}
.arrow span {
