...
if __name__ == '__main__':
    ...
    try:
        ...
        print('open city_dict.json failed, use default city_dict')
    ...
    for city in city_name.keys():
        ...
        for index, row in df.iterrows():
            try:
                ...
                cursor.execute(sql, (city_name[city], row.name.strftime('%Y-%m-%d'), row[city], row[city]))
                conn.commit()
